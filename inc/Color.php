...
require_once(dirname(__FILE__).'/Color_Base.php');
 ...
 */
class Origin_Color extends Origin_Color_Base{
	/**
	 ...
	 */
	public static function distance(Origin_Color $c1, Origin_Color $c2){
		return sqrt(
